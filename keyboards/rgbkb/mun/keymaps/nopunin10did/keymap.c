...
#define RCBE     RCTL_T(KC_END)
#define RSDASH   RSFT_T(KC_MINS)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [_QWERTY] = LAYOUT(
        KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_GRV ,   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,     KC_EQL,   KC_BSPC,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_RBRC,   KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,     KC_LBRC,  KC_BSLS,  
        KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_EQL,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,  KC_ENT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    LSADEL,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  RSDASH,   KC_RSFT,
        KC_LCTL, KC_LGUI, KC_LALT, ADJUST,  FN,      KC_SPC,  KC_SPC,    ALGRHOM, ALGREND, KC_LEFT, KC_RIGHT,KC_DOWN , KC_UP,    RCBE
    ),
